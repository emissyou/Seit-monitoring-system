...
<div class="open-shift-wrap">
    ...
    <?php if($activeShift): ?>
        <div class="alert-card warning">
            ...
            <div>
                ...
                <br>
                <button onclick="cancelOpenShift(<?php echo e($activeShift->ShiftID); ?>)" style="margin-top:10px; padding: 6px 14px; font-size:12px; font-weight:600; background:transparent; border:1px solid #d97706; color:#92400e; border-radius:6px; cursor:pointer;">
                    Cancel Open Shift
                </button>
            </div>
        </div>
    ...
    <?php else: ?>
                ...
                <div class="open-shift-card-body">
                    <form method="POST" action="<?php echo e(route('shift.open')); ?>">
                                    ...
                                    <div class="pump-card-body">
                                        <?php $__currentLoopData = $pump->pumpFuels ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pumpFuel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="fuel-input-group">
                                                <label>
                                                    <span class="fuel-dot" style="background:<?php echo e($dotColor); ?>;"></span>
                                                    <?php echo e($fuelName); ?> — Opening Reading (L)
                                                </label>
                                                <input type="number"
                                                       step="0.001"
                                                       ...
                                                       placeholder="<?php echo e(number_format($pumpFuel->totalizer_reading, 3)); ?>"
                                                       required>
                                            </div>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </div>
                        ...
                        <div class="submit-section">
                            ...
                            <a href="<?php echo e(route('shift.management', ['view' => 'home'])); ?>" class="btn-cancel-link">
                                Cancel
                            </a>
                        </div>
                    </form>
        ...
        <?php endif; ?>
    <?php endif; ?>
</div><?php /**PATH C:\Users\john mark bolanon\laravel\Seal-gasolineStation\resources\views/Shift/partials/open.blade.php ENDPATH**/ ?>
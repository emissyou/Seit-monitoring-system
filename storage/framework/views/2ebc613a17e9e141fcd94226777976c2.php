                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item" href="#"
                                        onclick="openEditModal(
                                            ...
                                            [<?php echo e($pump->pumpFuels->pluck('FuelID')->join(',')); ?>]
                                        )">
                            ...
                            <?php $__currentLoopData = $fuels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fuel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox"
                                           name="fuel_ids[]" value="<?php echo e($fuel->FuelID); ?>"
                                           id="add_fuel_<?php echo e($fuel->FuelID); ?>">
                                    <label class="form-check-label" for="add_fuel_<?php echo e($fuel->FuelID); ?>">
                        ...
                        <div class="d-flex flex-column gap-2 mt-1">
                            <?php $__currentLoopData = $fuels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fuel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-check">
                                    ...
                                    <label class="form-check-label" for="edit_fuel_<?php echo e($fuel->FuelID); ?>">
                                        <?php echo e($fuel->fuel_name); ?>

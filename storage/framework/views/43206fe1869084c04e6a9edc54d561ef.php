    ...
    <div class="archive-card">
        ...
        <div class="archive-card-header">
            ...
            <div class="archive-count-badge">
                ...
                <?php echo e($archivedShifts->total()); ?> total
            </div>
        </div>
        ...
        <form method="GET">
            ...
            <div class="filter-row">
                <div class="filter-field">
                    <label>From</label>
                    <input type="date" name="archive_from" value="<?php echo e(request('archive_from')); ?>">
                </div>
                <div class="filter-field">
                    <label>To</label>
                    <input type="date" name="archive_to" value="<?php echo e(request('archive_to')); ?>">
                </div>
                <button type="submit" class="btn-filter">
                    <i class="bi bi-funnel"></i> Filter
                </button>
                <?php if(request('archive_from') || request('archive_to')): ?>
                    <a href="<?php echo e(route('shift.management', ['view' => 'archive'])); ?>" class="btn-clear">
            ...
            <table class="data-table">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $archivedShifts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $shift): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <div style="font-weight:600; color:#111827;"><?php echo e($shift->sales_date->format('M d, Y')); ?></div>
                            ...
                            <td style="color:#ef4444;">₱<?php echo e(number_format($shift->db_discount, 2)); ?></td>
                            <td>₱<?php echo e(number_format($shift->db_credit, 2)); ?></td>
                            <td style="font-weight:700; color:#111827;">₱<?php echo e(number_format($shift->db_net, 2)); ?></td>
                            <td>₱<?php echo e(number_format($shift->db_cash_in_hand, 2)); ?></td>
                            <td style="color:#9ca3af; font-size:12px;"><?php echo e($shift->closed_at?->format('M d, h:i A') ?? '—'); ?></td>
                            <td>
                                <div class="action-group">
                                    <a href="<?php echo e(route('shift.view', $shift->ShiftID)); ?>" class="btn-icon view" title="View shift details">
                                        <i class="bi bi-eye"></i> View
                                    </a>
                                    <button type="button" class="btn-icon restore" onclick="restoreShift(<?php echo e($shift->ShiftID); ?>)" title="Restore to dashboard">
                                        <i class="bi bi-arrow-counterclockwise"></i> Restore
                                    </button>
                                    <button type="button" class="btn-icon delete" onclick="deleteShift(<?php echo e($shift->ShiftID); ?>)" title="Permanently delete">

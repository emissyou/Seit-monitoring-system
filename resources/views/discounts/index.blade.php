...
<div class="cl-page-header">
    ...
    <div class="d-flex gap-2">
        <a href="{{ route('discounts.export', request()->query()) }}" class="btn-export">
...
<div class="cl-summary-grid">
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ $activeCount }}</div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ $inactiveCount }}</div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ $expiredCount }}</div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ $perLiterCount }}</div>
        <div class="cl-stat-sub">{{ $allDiscounts->count() }} total discounts</div>
    </div>
...
<div class="cl-filter-bar">
    <form method="GET" action="{{ route('discounts.index') }}" class="row g-3 align-items-end">
        ...
        <div class="col-md-2">
            ...
            <select name="discount_type" class="form-select form-select-sm">
                ...
                <option value="per_liter"    {{ request('discount_type') === 'per_liter'    ? 'selected' : '' }}>Per Liter</option>
                <option value="fixed_amount" {{ request('discount_type') === 'fixed_amount' ? 'selected' : '' }}>Fixed Amount</option>
        ...
        <div class="col-md-1 d-flex gap-2 align-items-end">
            ...
            <a href="{{ route('discounts.index') }}" class="btn-reset" title="Clear filters">
                    ...
                    <tr>
                        <td>
                            <div class="cl-customer">
                                ...
                                <div>
                                    <div class="cl-customer-name">{{ $discount->customer_name }}</div>
                                    <div style="font-size:0.72rem;color:var(--ink-3);">#D-{{ str_pad($discount->DiscountID, 4, '0', STR_PAD_LEFT) }}</div>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            <div class="cl-validity-wrap">
                                <div class="cl-validity-dates">
                                    <b>{{ $discount->start_date?->format('M d') ?? '—' }}</b>
                                    <span class="arr">→</span>
                                    <b>{{ $discount->end_date?->format('M d, Y') ?? '—' }}</b>
                                </div>
                                <div class="cl-validity-bar">
                                    <div class="cl-validity-fill" style="width:{{ $pct }}%;background:{{ $barColor }};"></div>
                                </div>
                            </div>
                        </td>

                        <td>
                            <span class="cl-desc" title="{{ $discount->description }}">

...
<div class="cl-page-header">
    ...
    <a href="{{ route('credits.export', request()->query()) }}" class="btn-export">
...
<div class="cl-summary-grid">
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">&#8369;{{ number_format($totalAmount, 2) }}</div>
        <div class="cl-stat-sub">{{ $allCredits->count() }} transaction{{ $allCredits->count() !== 1 ? 's' : '' }}</div>
    </div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">&#8369;{{ number_format($totalPaid, 2) }}</div>
        <div class="cl-stat-sub">{{ $allCredits->where('status','paid')->count() }} fully paid</div>
    </div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">&#8369;{{ number_format($totalRemaining, 2) }}</div>
        <div class="cl-stat-sub">{{ $allCredits->where('status','partial')->count() }} partial</div>
    </div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ $countUnpaid }}</div>
...
<div class="cl-filter-bar">
    <form method="GET" action="{{ route('credits.index') }}" class="row g-3 align-items-end">
            ...
            <select name="customer_id" class="form-select form-select-sm">
                ...
                @foreach($customers as $customer)
                    <option value="{{ $customer->CustomerID }}"
                        {{ request('customer_id') == $customer->CustomerID ? 'selected' : '' }}>
        ...
        <div class="col-md-3 d-flex gap-2 align-items-end">
            ...
            <a href="{{ route('credits.index') }}" class="btn-reset" title="Clear filters">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="cl-customer">
                                ...
                                <span class="cl-customer-name">{{ $credit->customer_name }}</span>
                            </div>
                        </td>
                        ...
                        <td class="text-end">
                            <div class="cl-balance-wrap">
                                <span class="cl-mono" style="font-weight:700;color:{{ $credit->remaining_balance > 0 ? 'var(--red)' : 'var(--ink-4)' }};">
                                    &#8369;{{ number_format($credit->remaining_balance, 2) }}
                                </span>
                                <div class="cl-balance-bar">
                                    <div class="cl-balance-fill" style="width:{{ $pct }}%;background:{{ $fillColor }};"></div>
                                </div>
                            </div>
                        </td>

                        <td>
                            <span class="cl-badge cl-badge-{{ $credit->status ?? 'unpaid' }}">
                                {{ ucfirst($credit->status ?? 'unpaid') }}
                            </span>
                        </td>
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    <li>
                                        <a class="dropdown-item" href="#"
                                           onclick="viewCreditDetail({{ $credit->CreditID }})">

            ...
            <table class="table table-hover align-middle">
                ...
                <tbody>
                    @forelse($customers as $customer)
                        ...
                        @endphp
                        <tr>
                            {{-- FIX: use CustomerID (primary key) not ->id --}}
                            <td class="text-muted small">{{ $customer->CustomerID }}</td>

                            {{-- FIX: correct column names (First_name / Middle_name / Last_name) --}}
                            ...
                            <td class="text-center">
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li>
                                            {{-- FIX: data-id uses CustomerID; data-* use correct column names --}}

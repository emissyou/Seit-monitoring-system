...
<div class="cl-page-header">
    ...
    <a href="{{ route('totalizer.export', request()->query()) }}" class="btn-export">
...
<div class="cl-summary-grid">
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ number_format($totalReadings) }}</div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ number_format($totalVolume, 0) }}</div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value">{{ $uniquePumps }}</div>
    ...
    <div class="cl-stat">
        ...
        <div class="cl-stat-value" style="font-size:1.1rem;">
            {{ $latestDate ? \Carbon\Carbon::parse($latestDate)->format('M d') : '—' }}
        </div>
        <div class="cl-stat-sub">
            {{ $latestDate ? \Carbon\Carbon::parse($latestDate)->format('Y') : 'no records yet' }}
        </div>
    </div>
...
<div class="cl-filter-bar">
    <form method="GET" action="{{ route('totalizer.index') }}" class="row g-3 align-items-end">
        ...
        <div class="col-md-2 d-flex gap-2 align-items-end">
            ...
            <a href="{{ route('totalizer.index') }}" class="btn-reset" title="Clear filters">
            ...
            <tbody>
                @forelse($logs as $log)
                    <tr>
                        ...
                        <td class="text-end">
                            <span class="cl-mono-bold">{{ number_format($log->reading, 3) }}</span>
